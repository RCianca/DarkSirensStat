...
print('Saving files')
gwfast.gwfastUtils.save_data(COV_SAVE_PATH+'SNR_more_than_100_2400_2500.h5', Allevents_DS)
totFET = myET.FisherMatr(Allevents_DS)
print('The computed Fisher matrix has shape %s'%str(totFET.shape))
np.save(COV_SAVE_PATH+'Fish_SNR_more_than_100_2400_2500',totFET)
totCov_ET, inversion_err_ET = CovMatr(totFET)
#name='Allevents_from_Uniform_complete'
np.save(COV_SAVE_PATH+'Cov_SNR_more_than_100_2400_2500',totCov_ET)
