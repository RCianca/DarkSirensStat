...
#---------------------Beta---------------------------
s=0.10
mydlmax=14211.477971570035#MyCat['Luminosity Distance'].max()#10_400#Dl_z(zds_max,href,Om0GLOB)
mydlmin=7584.382576142516#MyCat['Luminosity Distance'].min()#8_950#Dl_z(zds_min,href,Om0GLOB)
