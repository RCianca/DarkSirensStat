...
if not exist:
    ...
    os.mkdir('results')
runpath='0P-DefaultUniform-SigmaAng05VMF-scattered_00'
...
if DS_read==1:
    ...
    #ds_phi_scat=np.random.normal(loc=ds_phi, scale=sigma_phi, size=None)
    #ds_theta_scat=np.random.normal(loc=ds_theta, scale=sigma_phi, size=None)
...
print('H0 grid saved')
os.system('cp run05scat.py '+folder+'/run.py')
